...
const Carousel = () => {
    ...
    return (
        ...
        <div className="mx-auto grid md:grid-cols-11 lg:grid-cols-10  p-4 gap-4 w-full h-[80dvh] border border-white/20 my-8 rounded-2xl">
            ...
            {carouselItems.map((item, index) => (
                <div
                    ...
                    className={`${item.span} h-full rounded-md bg-cover bg-center transition-transform duration-300 hover:cursor-grab hover`}
                >
